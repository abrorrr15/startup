      ...
      {posts?.map((post) => (
        ...
        >
          <Swiper
            ...
            slidesPerView={1}
          >
            <SwiperSlide key={post.id} className="w-full h-full aspect-square">
              <Image
            ...
            <div className="flex gap-2 justify-between">
              <p
                className={`w-fit h-fit p-1 rounded-lg font-mono lowercase text-white ${
                  (post.quality === "Новый" && "bg-green-500 animate-pulse") ||
              ...
              <Link href="#">
                <p className="bg-gray-300 w-fit h-fit rounded-md text-sm">
                  Подробнее &rarr;
                </p>
              </Link>
            </div>
